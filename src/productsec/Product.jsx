    ...
    <section className=" mx-auto px-2">
      <div className="flex flex-col md:flex-row flex-grow w-[100%]">
        <div className="bg-[#E5E5E5] max-w-3xl">
          <div className="text-center p-10 flex flex-col md:flex-row bg-white items-center">
            <img src="./necklace.png" alt="Necklaces" className="rounded-lg" />
          ...
          <div className="flex flex-col md:flex-row">
            <div className="justify-center items-center pl-20 pr-10 md:pr-29 flex flex-row bg-[#E5E5E5]">
              <img src="./ring.png" alt="Necklaces" className="rounded-lg" />
              <div>
        ...
        <div className="flex flex-col md:flex-row max-w-[100%]">
          <div className="bg-[#E5E5E5] pl-20 pb-20 pt-20 pr-25 flex flex-col text-center justify-center items-center">
            <h2 className="text-3xl font-semibold">Earrings</h2>
            <p className="text-sm text-gray-600 mt-2 max-w-100">
              The new 15-inch MacBook Air makes room for more of what you love
              with a spacious Liquid Retina display.
            </p>
            <button className="mt-4 px-6 py-2 border border-[#4B2C7A] text-[#4B2C7A] rounded hover:bg-[#4B2C7A] hover:text-white transition">
              Shop Now
            </button>
          </div>
          <div>
            <img
              src="./image 66.png"
              alt="Necklaces"
              className=" hidden md:flex w-full h-[100%] rounded-lg"
            />
          </div>
        </div>
      </div>
